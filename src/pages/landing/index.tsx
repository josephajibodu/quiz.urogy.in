  ...
  return (
    <>
      ...
      <div className="aspect-video border-brand border-2 h-52 lg:h-[600px] rounded-3xl mt-28 relative overflow-hidden">
        ...
        {/* eslint-disable-next-line @typescript-eslint/no-unsafe-assignment */}
        <YouTube className="w-full h-full" iframeClassName="w-full h-full" videoId="JkRXhe3KaPE" opts={options} onEnd={onEnd} onReady={onReady} onPlay={onPlay} onPause={onPause} />

        {showPlayBtn && <div onClick={handlePlayButton} className="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] cursor-pointer">
